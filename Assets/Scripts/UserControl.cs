...
public class UserControl : MonoBehaviour
{
    ...
    public void HandleSelection()// this will manage everything that occurs when user left clicks to select forklifts
    {
    ...
    public void HandleAction()// will handle the action of the forklifts when user right clicks 
    {
        var ray = GameCamera.ScreenPointToRay(Input.mousePosition);
            RaycastHit hit;
            if (Physics.Raycast(ray, out hit))
